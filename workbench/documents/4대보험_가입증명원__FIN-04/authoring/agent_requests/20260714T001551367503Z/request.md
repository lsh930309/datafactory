# Agentic Authoring Request: 4대보험 가입증명원 (FIN-04)
...
- 문서 ID: FIN-04
- PO 도메인: 금융, 인사
- 업무 도메인: 금융 - 은행 (여신·신용·외환), 인사·노무 (공통)
...
- 날짜와 연령 관계는 요청의 고정 기준일 `2026-07-14`을 기준으로 설계한다. 미래 날짜를 만들지 말고 실행 시각에 따라 결과가 달라지는 암묵적 today를 전제로 하지 않는다.
...
## 입력 파일
- sample: workbench/documents/4대보험_가입증명원__FIN-04/samples/original/4대보험가입확인서.pdf
- latestReview: workbench/documents/4대보험_가입증명원__FIN-04/review/original_4대보험가입확인서_page_001/review.json
- latestInpainted: workbench/documents/4대보험_가입증명원__FIN-04/inpaint/original_4대보험가입확인서_page_001/lama/inpainted_lama.png
- visualEvidenceManifest: workbench/documents/4대보험_가입증명원__FIN-04/authoring/agent_requests/20260714T001551367503Z/visual_evidence_manifest.json
