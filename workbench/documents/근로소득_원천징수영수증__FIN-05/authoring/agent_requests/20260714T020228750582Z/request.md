# Agentic Authoring Request: 근로소득 원천징수영수증 (FIN-05)
...
- 문서 ID: FIN-05
- PO 도메인: 금융, 인사
- 업무 도메인: 금융 - 은행 (여신·신용·외환), 금융 - 카드·여신전문, 인사·노무 (공통)
...
## 입력 파일
- sample: workbench/documents/근로소득_원천징수영수증__FIN-05/samples/original/근로소득원천징수영수증.pdf
- latestReview: workbench/documents/근로소득_원천징수영수증__FIN-05/review/original_근로소득원천징수영수증_page_001/review.json
- latestInpainted: -
- visualEvidenceManifest: workbench/documents/근로소득_원천징수영수증__FIN-05/authoring/agent_requests/20260714T020228750582Z/visual_evidence_manifest.json
