# Agentic Authoring Request: 내부 심사·결재 문서 [산출물] (RPT-07)
...
- 문서 ID: RPT-07
- PO 도메인: 금융, 공공, 건설, 회계
- 업무 도메인: 건설·부동산, 공공·행정 (B2G), 금융 - 은행 (여신·신용·외환), 회계·세무 (공통)
...
## 입력 파일
- sample: workbench/documents/내부_심사·결재_문서_[산출물]__RPT-07/samples/original/06월개인경비.pdf
- latestReview: workbench/documents/내부_심사·결재_문서_[산출물]__RPT-07/review/original_06월개인경비_page_001/review.json
- latestInpainted: workbench/documents/내부_심사·결재_문서_[산출물]__RPT-07/inpaint/original_06월개인경비_page_001/lama/inpainted_lama.png
- visualEvidenceManifest: workbench/documents/내부_심사·결재_문서_[산출물]__RPT-07/authoring/agent_requests/20260713T014546637760Z/visual_evidence_manifest.json
