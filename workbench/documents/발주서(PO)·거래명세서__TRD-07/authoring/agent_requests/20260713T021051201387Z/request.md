# Agentic Authoring Request: 발주서(PO)·거래명세서 (TRD-07)
...
## 입력 파일
- sample: workbench/documents/발주서(PO)·거래명세서__TRD-07/samples/original/발주서.pdf
- latestReview: workbench/documents/발주서(PO)·거래명세서__TRD-07/review/original_발주서_page_001/review.json
- latestInpainted: workbench/documents/발주서(PO)·거래명세서__TRD-07/inpaint/original_발주서_page_001/lama/inpainted_lama.png
- visualEvidenceManifest: workbench/documents/발주서(PO)·거래명세서__TRD-07/authoring/agent_requests/20260713T021051201387Z/visual_evidence_manifest.json
