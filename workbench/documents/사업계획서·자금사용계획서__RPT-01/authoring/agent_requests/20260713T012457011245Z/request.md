# Agentic Authoring Request: 사업계획서·자금사용계획서 (RPT-01)
...
- 문서 ID: RPT-01
- PO 도메인: 금융, 공공
- 업무 도메인: 공공·행정 (B2G), 금융 - 은행 (여신·신용·외환)
...
## 입력 파일
- sample: workbench/documents/사업계획서·자금사용계획서__RPT-01/samples/original/자금사용계획서.pdf
- latestReview: workbench/documents/사업계획서·자금사용계획서__RPT-01/review/original_자금사용계획서_page_002/review.json
- latestInpainted: -
- visualEvidenceManifest: workbench/documents/사업계획서·자금사용계획서__RPT-01/authoring/agent_requests/20260713T012457011245Z/visual_evidence_manifest.json
