# Agentic Authoring Request: 상업송장(Commercial Invoice) (TRD-01)
...
## 입력 문서 컨텍스트
- 제목: 상업송장(Commercial Invoice)
- 문서 ID: TRD-01
- PO 도메인: 제조, 무역
- 업무 도메인: 무역·물류, 제조·구매·SCM
...
## 입력 파일
- sample: workbench/documents/상업송장(Commercial_Invoice)__TRD-01/samples/original/상업송장.png
- latestReview: workbench/documents/상업송장(Commercial_Invoice)__TRD-01/review/original_상업송장/review.json
- latestInpainted: workbench/documents/상업송장(Commercial_Invoice)__TRD-01/inpaint/original_상업송장/lama/inpainted_lama.png
- visualEvidenceManifest: workbench/documents/상업송장(Commercial_Invoice)__TRD-01/authoring/agent_requests/20260713T015411707890Z/visual_evidence_manifest.json
