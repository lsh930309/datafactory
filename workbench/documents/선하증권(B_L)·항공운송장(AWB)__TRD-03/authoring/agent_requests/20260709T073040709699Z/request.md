...
## 사용자 지시
bbox마다 참조할 만한 값이 있는 것도 있고 없는 것도 있는데 실제 문건이나 이 문서를 작성하는 방법, 이 문서가 나타내는 정보 등에 대해 리서치한 결과를 바탕으로 최대한 디테일한 작업을 진행해줘.
...
- visualEvidenceManifest: workbench/documents/선하증권(B_L)·항공운송장(AWB)__TRD-03/authoring/agent_requests/20260709T073040709699Z/visual_evidence_manifest.json
