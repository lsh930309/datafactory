# Agentic Authoring Request: 수술기록지 (MED-08)
...
## 사용자 지시
수술코드/수술명/수량/주수술/부수술 부분 데이터는 1개 샘플당 최대 3개 행으로 우선 만들어줘.
재료처치 섹션(재료/수량)도 각기 큰 크기의 단일 bbox로 지정했는데, 동일하게 최대 5개 행이 될 수 있도록 데이터를 준비해 주면 돼.
주입되는 데이터가 하나의 샘플 내에서 반드시 유효성을 만족하도록, 한 개인의 수술 상황을 모델링 가능한 관계식을 정확하게 정의하며 작업해줘.
...
## 입력 파일
- sample: workbench/documents/수술기록지__MED-08/samples/original/수술기록지.pdf
- latestReview: workbench/documents/수술기록지__MED-08/review/original_수술기록지_page_001/review.json
- latestInpainted: -
- visualEvidenceManifest: workbench/documents/수술기록지__MED-08/authoring/agent_requests/20260709T061457836626Z/visual_evidence_manifest.json
