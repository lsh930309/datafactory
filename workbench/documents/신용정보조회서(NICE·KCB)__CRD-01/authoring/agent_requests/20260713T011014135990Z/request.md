# Agentic Authoring Request: 신용정보조회서(NICE·KCB) (CRD-01)
...
- 문서 ID: CRD-01
- PO 도메인: 금융
- 업무 도메인: 금융 - 은행 (여신·신용·외환), 금융 - 카드·여신전문
...
## 입력 파일
- sample: workbench/documents/신용정보조회서(NICE·KCB)__CRD-01/samples/original/개인신용정보서.pdf
- latestReview: workbench/documents/신용정보조회서(NICE·KCB)__CRD-01/review/authoring_migrated/review.json
- latestInpainted: workbench/documents/신용정보조회서(NICE·KCB)__CRD-01/inpaint/original_개인신용정보서_page_001/lama/inpainted_lama.png
- visualEvidenceManifest: workbench/documents/신용정보조회서(NICE·KCB)__CRD-01/authoring/agent_requests/20260713T011014135990Z/visual_evidence_manifest.json
