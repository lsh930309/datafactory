# Agentic Authoring Request: 여신신청서 (APP-01)
...
## 사용자 지시
페이지 최상단의 2행 5열짜리 그리드 표의 경우, 윗줄은 [직책명], 아랫줄에는 [서명]이 들어가야 할 거 같아. 일단은 [서명]은 [사람 이름(한국인)]으로 주입할 수 있도록 대처해주고, 실제 서명 시뮬레이션은 따로 처리해볼게.
...
## 입력 파일
- sample: workbench/documents/여신신청서__APP-01/samples/original/여신승인신청서.pdf
- latestReview: workbench/documents/여신신청서__APP-01/review/original_여신승인신청서_page_001/review.json
- latestInpainted: -
- visualEvidenceManifest: workbench/documents/여신신청서__APP-01/authoring/agent_requests/20260708T024251787812Z/visual_evidence_manifest.json
