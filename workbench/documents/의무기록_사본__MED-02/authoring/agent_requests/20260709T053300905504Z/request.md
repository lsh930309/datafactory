# Agentic Authoring Request: 의무기록 사본 (MED-02)
...
## 사용자 지시
- '치료내용' 섹션의 bbox 3분할의 경우는 원본 문서처럼 1, 2, 3 번호를 붙여 가면서 치료 내용을 묘사해 줬으면 해서 분할한 거야.
- '진단명' 섹션의 경우에도 좌우 bbox를 나눠서, 질병관리코드와 진단 병명 등을 나눠서 관리 및 주입할 수 있도록 구성해뒀어.
- 원본 문서에서 "-" 등 별 내용 없이 간단히 나타난 부분에도, 현실적이면서도 다채로운 값이 주입될 수 있도록 리서치를 통해서 고품질의 데이터를 준비해줘.
- 이외에는 이 한 문서에서 일관된 개인의 의료 상황이 정확하게 모델링될 수 있도록 각 데이터간의 연계 관계 정립에 주의해 줘!
...
## 입력 파일
- sample: workbench/documents/의무기록_사본__MED-02/samples/original/의무기록.png
- latestReview: workbench/documents/의무기록_사본__MED-02/review/original_의무기록/review.json
- latestInpainted: workbench/documents/의무기록_사본__MED-02/inpaint/original_의무기록/lama/inpainted_lama.png
- visualEvidenceManifest: workbench/documents/의무기록_사본__MED-02/authoring/agent_requests/20260709T053300905504Z/visual_evidence_manifest.json
