# Agentic Authoring Request: 처방전·약제비영수증 (MED-06)
...
## 사용자 지시
계산서/영수증 양식에 해당하는 문건이라서 특히 각 key 간의 긴밀한 연계(의존) 관계와 데이터 합계 등의 유효성 품질이 정말 중요해. 이것에 유의해서 작업 부탁해.
+ '현금영수증' 우측의 bbox는 체크박스로 처리해주면 돼!
...
## 입력 파일
- sample: workbench/documents/처방전·약제비영수증__MED-06/samples/original/약제비계산서.pdf
- latestReview: workbench/documents/처방전·약제비영수증__MED-06/review/original_약제비계산서_page_001/review.json
- latestInpainted: -
- visualEvidenceManifest: workbench/documents/처방전·약제비영수증__MED-06/authoring/agent_requests/20260709T042403496711Z/visual_evidence_manifest.json
